...
The list is defined once in `backend/users/instruments.py` and mirrored for the
picker in `apps/mobile/src/data/instruments.ts`. Each entry carries the clef the
